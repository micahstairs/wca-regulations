...
- A1a2++) [EXAMPLE] If a round has a cumulative time limit of 30 minutes and the competitor's results first two attempts are 6:20.96 and DNF (10:20), then the time limit for the third attempt is 30:00.00 - 6:20.96 - 10:20 = 13:19.04. For this particular example, note that only the final result for an attempt counts. Therefore, a third attempt with an original recorded time of 13:19.45 without penalties meets the time limit because the final result is 13:19 (see [Regulation 9f2](regulations:regulation:9f2)), while a third attempt with a result of 13:18.00 + 2 = 13:20 does not meet the time limit.
